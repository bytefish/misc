...
export const UI_DATA: Record<string, UiTranslation> = {
  'DE': {
    ...
    languageNames: { 'DE': 'Deutsch', 'EN': 'Englisch', 'ES': 'Spanisch', 'FR': 'Französisch', 'CN': 'Chinesisch' }
  },
  'EN': {
    name: 'EN',
    ...
    languageNames: { 'DE': 'German', 'EN': 'English', 'ES': 'Spanish', 'FR': 'French', 'CN': 'Chinese' }
  },
  'ES': {
    name: 'ES',
    ...
    languageNames: { 'DE': 'Alemán', 'EN': 'Inglés', 'ES': 'Español', 'FR': 'Francés', 'CN': 'Chino' }
  },
  'FR': {
    name: 'FR',
    ...
    languageNames: { 'DE': 'Allemand', 'EN': 'Anglais', 'ES': 'Espagnol', 'FR': 'Français', 'CN': 'Chinois' }
  },
  'CN': {
    name: 'CN',
    ...
    languageNames: { 'DE': '德语', 'EN': '英语', 'ES': '西班牙语', 'FR': '法语', 'CN': '中文' }
  }
};
